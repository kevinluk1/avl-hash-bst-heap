...
class MinHeap:
    ...
    def rec_build_heap(self, counter, parent_index, left_child_index, right_child_index, da_copy):
        ...
        if left_child_index > da_copy.length() - 1 >= right_child_index:  # if one element is out of bonds and the other is not
            smallest_child_index = right_child_index
        if right_child_index > da_copy.length() - 1 >= left_child_index:
            smallest_child_index = left_child_index
